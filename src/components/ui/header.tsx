    ...
    <header
      className={`bg-gray-800 text-white fixed shadow-lg z-50 transition-all duration-300 ease-in-out ${
        isTop
          ...
          : 'top-2 sm:top-4 left-1/2 w-11/12 rounded-xl transform -translate-x-1/2'
      } ${isTop ? 'p-2 sm:p-4' : 'p-1 sm:p-2'}`}
    >
      <nav className="container mx-auto flex justify-between items-center">
        ...
        <div className="sm:hidden">
          ...
          >
            <div className="block w-5 h-5 absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2">
              <span
                aria-hidden="true"
