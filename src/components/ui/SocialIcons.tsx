...
const SocialIcons: FC = () => (
  <div className="flex space-x-4">
    <a href="https://x.com/yamazemi2024" target="_blank" rel="noopener noreferrer">
      <FontAwesomeIcon icon={faXTwitter} className="w-6 h-6 text-white hover:text-gray-400" />
    </a>
    <a href="https://www.instagram.com/yamazemi2024/" target="_blank" rel="noopener noreferrer">
