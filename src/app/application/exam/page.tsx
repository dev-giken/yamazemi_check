  ...
  return (
    <>
      <main style={{ maxWidth: '1000px', margin: '0 auto' }}>
        <div style={{ paddingTop: '80px', paddingBottom: '400px'}}>
            <div className="w-full py-3 px-10">
                <Breadcrumb>
                    <BreadcrumbList className="flex text-gray-500 text-[10px]">
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                        <BreadcrumbPage>試験概要</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
            </div>
            <div className="flex flex-col justify-between">
                <div className="px-8 text-xs">
                    ...
                    .filter((item: MainContent) => {
                        console.log(item);
                        return item.title.includes('試験概要') && item.category_1.includes('セカンドトップ') && item.category_2.includes('入ゼミ');
                    })
